...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_question_mark_means_optional
    ...
    assert_equal "a", "abbcccddddeeeee"[/az?/] #looks for a and z, but z is optional, so does not return nil
  end

  def test_plus_means_one_or_more
    assert_equal "bccc", "abbcccddddeeeee"[/bc+/] #returns all occurances in a row, not just unique
  end
  ...
  def test_asterisk_means_zero_or_more
    ...
    # answer? never, unless the letter before or after it does not exist in the string (as long as it also doesnt have a *)
  ...
  def test_the_left_most_match_wins
    assert_equal "a", "abbccc az"[/az*/]   #if there is more than 1 word, 
  end
  ...
  def test_slash_a_anchors_to_the_start_of_the_string  #not sure what the pt of this is
  ...
  test_dollar_sign_anchors_to_the_end_of_lines
